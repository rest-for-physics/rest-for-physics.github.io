---
layout: default
title: Neutrinoless double beta decay example
parent: The restG4 package
nav_order: 30
---

## Neutrinoless double beta decay example
{: .no_toc }
...
Once successfully run (this may take a few mintues), the output `root` file will be saved in the local directory under something like `Run00001_NLDBD_Test.root`.
