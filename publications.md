...
- Javier Galan, *REST v2.0 : A data analysis and simulation framework for micro-patterned readout detectors.*, [8th Symposium on Large TPCs for low-energy rare event detection](https://indi.to/3hzcz), 2016-Dec.
